...
This is the platform pattern designed to build the system the WordPress service.
Currently supported:
...
Report issues and requests: <https://github.com/cloudconductor-patterns/simple_wordpress_pattern/issues>
